...
cd "`work'/code/"
capture log close
log using ./log/D4_phase2_analysis.log, replace
...
esttab mod_base mod_new mod_new1 mod_new2 mod_new3 using "`work'/output/tables/a0_comparison_with_baseline", ///
       star(* 0.10 ** 0.05 *** 0.01) ///
       se(a2) b(a2) noconstant nogaps label rtf replace ///
       interaction(" x ") nobaselevels noomitted ///
       eqlabels(none) scalar(N_clust) ///
       mlabels("Project choice" "Project choice" "Project choice" "Project choice" "Project choice")
...
esttab mod_arm mod_arm_cl using "`work'/output/tables/Table5_a1_treatment_arm_gmnl_cl", ///
       star(* 0.10 ** 0.05 *** 0.01) ///
       se(a2) b(a2) noconstant nogaps label rtf replace ///
       interaction(" x ") nobaselevels noomitted ///
       eqlabels(none) ///
       mlabels("Project choice" "Project choice")
...
graph export "`work'/output/graphs/project_choice_1_arm1_3.pdf", replace as(pdf)
graph export "`work'/output/graphs/project_choice_1_arm1_3.png", replace as(png)
...
esttab mod_loss1 mod_loss1_cl using "`work'/output/tables/a1_loss_aversion_lambda_gmnl_cl", ///
       star(* 0.10 ** 0.05 *** 0.01) ///
       se(a2) b(a2) nogaps label rtf replace ///
       interaction(" x ") nobaselevels noomitted ///
       eqlabels(none) scalars(N_clust) ///
       mlabels("Project choice" "Project choice")
