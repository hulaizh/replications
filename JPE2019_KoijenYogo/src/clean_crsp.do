...
replace prc=abs(prc)
merge 1:1 permno ym using "./temp/msedelist"

replace ret=dlret if _m==3
drop _m

merge 1:1 permno ym using "./temp/msenames.dta", nogen keep(match)
